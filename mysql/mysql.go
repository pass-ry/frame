...
func getConnStr(cfgMySQL Config) string {
	return fmt.Sprintf("%s:%s@tcp(%s:%s)/%s?charset=utf8&sql_notes=false&sql_notes=false&timeout=90s&collation=utf8mb4_unicode_ci&parseTime=True&loc=Local&interpolateParams=true",
